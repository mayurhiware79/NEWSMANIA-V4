      ...
      >
        ...
        >
          ...
          <motion.button
            ...
            disabled={loading}
            className="flex items-center justify-center gap-2 bg-gray-900 rounded-lg py-3 px-4 text-white hover:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition-colors shadow-sm hover:shadow"
            variants={buttonVariants}
            whileHover="hover"
            whileTap="tap"
